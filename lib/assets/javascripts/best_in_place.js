...
BestInPlaceEditor.prototype = {
    ...
    initOptions: function () {
        ...
        // fix rails ajax messup
        if (self.collection == "[[") {
          self.collection = [["false", "Everyone"], ["true", "You"]]
        }
...
BestInPlaceEditor.forms = {
    "input": {
        activateForm: function () {
            ...
            this.element.find("input[type='text']").bind('keypress', {editor: this}, BestInPlaceEditor.forms.input.keypressHandler);
